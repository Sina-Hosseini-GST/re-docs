...
<header class="fixed inset-x-0 top-0 z-10 text-sm text-white bg-black border-b border-gray-500 xl:text-base">
	<nav class="max-w-[96rem] w-full relative h-12 mx-auto xl:h-14">
		<ul class="flex h-full overflow-auto">
			<a class="flex items-center h-full font-bold xl:px-2 px-1.5" href="/">
				REdocs
			</a>
